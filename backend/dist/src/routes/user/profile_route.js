...
const profileController = __importStar(require("../../controllers/user/profile_controller"));
const profileRouter = express_1.default.Router();
// avatarUpload is middleware to handle the file upload for the avatar image
profileRouter.post("/avatar/create", upload_1.avatarUpload.single("image"), profileController.updateAvatar);
